...
- Completeness:
    - [ ] All expected architecture entities present in DB: architecture_overview, component, data_entity, adr, architecture_config, traceability_mapping, approved_dependency (query each via changelog_query); api_spec.yaml file artifact if APIs exist
