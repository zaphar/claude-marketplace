...
**Escalation:** If acceptance criteria have gaps, requirements are untestable, or architecture prevents proper test isolation — pause, tell user, write to `planning/BLOCKERS.md`. Escalate after 3 revision cycles.
